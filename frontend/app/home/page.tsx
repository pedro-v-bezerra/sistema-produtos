...
// Dados mockados - substituir por dados do backend
      ...
      <header className="bg-card/80 backdrop-blur-sm border-b border-border/50 sticky top-0 z-40">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-primary to-accent rounded-xl flex items-center justify-center">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Gerencie seus produtos facilmente</p>
            </div>
          </div>
          <Button
            variant="outline"
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {productsLoading ? (
            ...
            products.map((product) => (
              <Card key={product.id} className="group hover:shadow-lg transition-all duration-300 border-0 bg-card/50 backdrop-blur-sm hover:scale-[1.02]">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    <Dialog open={isFormOpen && selectedProduct?.id === product.id} onOpenChange={(open) => {
        ...
        {!productsLoading && products.length === 0 && (
          <div className="text-center py-12">
            ...
            <Button onClick={handleCreateProduct} className="bg-gradient-to-r from-primary to-accent hover:opacity-90 transition-opacity">
